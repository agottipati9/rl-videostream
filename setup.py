...
os.system("sudo ./get_mahimahi.sh")
...
os.system("sudo apt-get -y install xvfb xserver-xephyr tightvncserver unzip")
...
# tensorflow
os.system("pip install tensorflow tflearn h5py scipy matplotlib")
